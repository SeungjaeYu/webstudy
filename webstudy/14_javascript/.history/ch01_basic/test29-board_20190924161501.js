    ...
    switch (menu) {
        case 1 :
            ...
            if (list.length == 0) {
                ...
                list.forEach(function(val, idx, a){
                    console.log((idx + 1), val.title, val.writer, a  );
                });
            }
            console.log(`-------------------------------`);       
            break;
        ...
        case 3 :
            let title = parseInt(prompt("제목을 입력하세요 : "));
            let writer = parseInt(prompt("글쓴이를 입력하세요 : "));
            list.push({"title" : title, "writer" : writer});
