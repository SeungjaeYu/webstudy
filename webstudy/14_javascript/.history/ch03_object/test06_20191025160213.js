...
function setInfo(name, age, gender, addr) {
    return {this.name: name, age: age, gender: gender, addr: addr};
}

let m1 = setInfo('조조', 33, '남', '성남');
let m2 = setInfo('유비', 33, '남', '성남');
let m3 = setInfo('항우', 33, '남', '성남');
let m4 = setInfo('여포', 33, '남', '성남');
