...
function queryResult(query, queryType, queryStr) {
	let resultSetVal = "";
	function aa() {
		let resultSet = "";
		switch (queryType) {
	...
	console.log("11111", resultSetVal);
	return resultSetVal;
}
...
http.createServer((req, res) => {
   ...
   if (req.method === "GET") {
	  ...
	  let resultVal = queryResult(`
		   select * from tb_board
		   order by no desc`, "selectList"
	  )
	  console.log("222",resultVal);
      send(res, info, resultVal);
