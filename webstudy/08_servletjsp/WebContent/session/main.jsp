			...
			<ul>
				...
				<c:choose>
					<c:when test="${empty member}">
						<a href="loginform.do"> <i
								class="fa fa-user fa-lg"></i> <span class="nav-text">Login</span>
						</a>
					</c:when>
					<c:otherwise>
						<a href="logout.do"> <i
								class="fa fa-user fa-lg"></i> <span class="nav-text">Logout</span>
						</a>
					</c:otherwise>
				</c:choose>
				...
				<li><a href="http://startific.com"> <i
						class="fa fa-envelope-o fa-lg"></i> <span class="nav-text">Contact</span>
				</a></li>
				...
				<li><a href="http://startific.com"> <i
						class="fa fa-heart-o fa-lg"></i> <span class="share">
...
"
				...
				<li class="darkerlishadow"><a href="http://startific.com">
						<i class="fa fa-clock-o fa-lg"></i> <span class="nav-text">News</span>
				</a></li>
				...
				<li class="darkerli"><a href="http://startific.com"> <i
						class="fa fa-align-left fa-lg"></i> <span class="nav-text">Magazines
					</span>
				</a></li>
