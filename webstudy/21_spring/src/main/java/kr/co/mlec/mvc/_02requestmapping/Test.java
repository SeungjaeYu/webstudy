...
public class Test {
	...
	@RequestMapping("test02.do")	// /생략 가능. spring이 알아서 처리해줌
...
//	@RequestMapping(value="test06.do", method=RequestMethod.POST)
	...
	public String test071() {
		System.out.println("test073 호출 - application/json");
		return "redirect:/mvc/index02.jsp";
	}
	
	@RequestMapping(value="test07.do", consumes="application/x-www-form-urlencoded")
	public String test072() {
		System.out.println("test073 호출 - application/x-www-form-urlencoded");
		return "redirect:/mvc/index02.jsp";
	}
	
	@RequestMapping(value="test07.do")
